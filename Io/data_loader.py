...
from preprocessing.data_processor import MyPro, convert_examples_to_features,convert_inference_to_features
...
def create_batch_iter(mode):
    ...
    if args.do_inference:
        features = convert_inference_to_features(examples,label_list,args.max_seq_length,tokenizer)
    else:
    ...
    # 数据集
    if args.do_inference:
        data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_output_mask)
    else:
